...
pdflatex -interaction=nonstopmode -shell-escape -output-directory=build main_ieee.tex
if %ERRORLEVEL% neq 0 (
...
echo.
echo === Compilando ACM ===
pdflatex -interaction=nonstopmode -shell-escape -output-directory=build main_acm.tex
if %ERRORLEVEL% neq 0 (
...
pdflatex -interaction=nonstopmode -shell-escape -output-directory=build main_apa7.tex
if %ERRORLEVEL% neq 0 (
